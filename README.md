...
#### reducers/index.js
  ...
  * [1] Add in the arguments needed to complete a standard reducer function.
  * [1] Add in a reducer case to accommodate the start of a smurf fetch.
  * [1] Add in a reducer case to accommodate the successful smurf api fetch.
  * [1] Add in a reducer cases to accommodate the failed smurf api fetch.
  * [1] Add in a reducer case to accommodate adding a smurf (including the name, nickname, position, description and an internally generated id) into your smurf list.
  * [1] Add in a reducer case that adds in a value to the error message.
...
#### actions/index.js
  ...
  * [1] Add a standard action that allows us to add new smurf (including the name, nickname, position, summary).
  * [1] Add a standard action that allows us to set the value of the error message slice of state.
  
#### App.js
  Connect this component to redux **passing in your fetchSmurfs action only.** 
  
  * [1] Connect the fetchSmurfs actions to the App component.
  * [1] Call the fetchSmurfs action when the component first loads.
...
#### components/SmurfList.js
  ...
  * [1] Replace the single Smurf component instance with a map return a Smurf component for each entry in the smurfs list.
  * [1] Replace the static isLoading variable with the state loading variable.
